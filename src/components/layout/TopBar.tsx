...
export const TopBar: React.FC = () => {
  ...
  return (
    <div className="bg-slate-950 text-slate-300 text-xs border-b border-slate-800">
      ...
      {storeSettings?.announcementActive && storeSettings.heroAnnouncementText && (
        <div className="bg-gradient-to-r from-amber-600 via-amber-500 to-amber-600 text-slate-950 px-4 py-1.5 text-center font-bold text-[11px] tracking-wide flex items-center justify-center gap-2">
          <span>{storeSettings.heroAnnouncementText}</span>
        </div>
      )}
